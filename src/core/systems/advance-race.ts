...
import { IsRemotePlayer, Player, PlayerInput, RaceProgress, Time } from "../traits";
...
export function advanceRace(world: World) {
  ...
  // AI-controlled geese (no PlayerInput trait, not remote players)
  world
    .query(RaceProgress, Player, Not(PlayerInput), Not(IsRemotePlayer))
